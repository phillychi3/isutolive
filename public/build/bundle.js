...
var app = (function () {
    ...
    function create_then_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*data*/ ctx[7][0].status == 'OK') return create_if_block_2;
    	}
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "天使正在開台";
    			t1 = space();
    			iframe = element("iframe");
    			add_location(h2, file, 57, 3, 1616);
    			...
    			add_location(iframe, file, 58, 3, 1635);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			iframe = element("iframe");
    			add_location(h2, file, 54, 3, 1336);
    			attr_dev(iframe, "width", "560");
    			attr_dev(iframe, "height", "315");
    			if (!src_url_equal(iframe.src, iframe_src_value = /*data*/ ctx[7][0].link)) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "title", "YouTube video player");
    			...
    			attr_dev(iframe, "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");
    			iframe.allowFullscreen = true;
    			add_location(iframe, file, 55, 3, 1357);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = text(/*sec*/ ctx[3]);
    			t12 = text("秒");
    			add_location(h20, file, 49, 3, 1163);
    			html_tag.a = t2;
    			add_location(h21, file, 51, 3, 1233);
    			add_location(p, file, 52, 3, 1254);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(49:2) {#if data[0].status == 'NONE'}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(46:17)   <p>讀取資料中</p>  {:then data}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-19wor6o");
    			add_location(img, file, 41, 3, 1027);
    			attr_dev(div0, "class", "layer svelte-19wor6o");
    			add_location(div0, file, 39, 3, 955);
    			attr_dev(div1, "class", "bg svelte-19wor6o");
    			add_location(div1, file, 38, 1, 935);
    			attr_dev(h1, "class", "svelte-19wor6o");
    			add_location(h1, file, 44, 1, 1064);
    			attr_dev(main, "class", "svelte-19wor6o");
    			add_location(main, file, 37, 0, 927);
    		},
