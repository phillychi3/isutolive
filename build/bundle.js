...
var app = (function () {
    ...
    var Timestamp = function () {
      ...
      _createClass(Timestamp, [{
        ...
        value: function fromDate(date) {
          ...
          var unit = options.unit ? options.unit : this.unit;
        ...
        value: function fromDatetimeString(datetimeString) {
          var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

          var format = options.format ? options.format : this.format;
          var timezone = options.timezone ? options.timezone : this.timezone;
          var unit = options.unit ? options.unit : this.unit;
          return parseInt(momentTimezone(datetimeString, format).tz(timezone).format(unit === 'ms' ? 'x' : 'X'));
        }
      }, {
        key: 'toDatetimeString',
        value: function toDatetimeString(datetimeTimestamp) {
          var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

          var format = options.format ? options.format : this.format;
          var timezone = options.timezone ? options.timezone : this.timezone;
          return momentTimezone.unix(parseInt(datetimeTimestamp, 10)).tz(timezone).format(format);
        }
      }]);
    ...
    function create_then_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*data*/ ctx[7][0].status == 'NONE') return create_if_block;
    		if (/*data*/ ctx[7][0].status == 'LIVE_OFFLINE') return create_if_block_1;
    		if (/*data*/ ctx[7][0].status == 'OK') return create_if_block_4;
    	}
    ...
    function create_if_block_4(ctx) {
    	...
    	function select_block_type_2(ctx, dirty) {
    		if (/*data*/ ctx[7][0].platform == 'youtube') return create_if_block_5;
    		if (/*data*/ ctx[7][0].platform == 'twitch') return create_if_block_6;
    	}
    ...
    function create_if_block_1(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*data*/ ctx[7][0].platform == 'youtube') return create_if_block_2;
    		if (/*data*/ ctx[7][0].platform == 'twitch') return create_if_block_3;
    	}
    ...
    // (55:2) {#if data[0].status == 'NONE'}
    function create_if_block(ctx) {
    	let h20;
    	let t1;
    	let html_tag;
    	let raw_value = /*totimestamp*/ ctx[4](/*data*/ ctx[7][0].laststreamtime) + "";
    	let t2;
    	let h21;
    	let t4;
    	let p;
    	...
    	const block = {
    		c: function create() {
    			h20 = element("h2");
    			h20.textContent = "天使現在還沒有開台喔";
    			t1 = space();
    			html_tag = new HtmlTag(false);
    			t2 = space();
    			h21 = element("h2");
    			h21.textContent = "距離上次開台時間";
    			t4 = space();
    			p = element("p");
    			t5 = text(/*day*/ ctx[0]);
    			t6 = text("天");
    			...
    			t11 = text(/*sec*/ ctx[3]);
    			t12 = text("秒");
    			add_location(h20, file, 55, 3, 1396);
    			html_tag.a = t2;
    			add_location(h21, file, 57, 3, 1468);
    			add_location(p, file, 58, 3, 1490);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*day*/ 1) set_data_dev(t5, /*day*/ ctx[0]);
    			if (dirty & /*hour*/ 2) set_data_dev(t7, /*hour*/ ctx[1]);
    			if (dirty & /*min*/ 4) set_data_dev(t9, /*min*/ ctx[2]);
    			if (dirty & /*sec*/ 8) set_data_dev(t11, /*sec*/ ctx[3]);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(55:2) {#if data[0].status == 'NONE'}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "天使現在正在開台喔!";
    			t1 = space();
    			iframe = element("iframe");
    			add_location(h2, file, 72, 4, 2447);
    			if (!src_url_equal(iframe.src, iframe_src_value = /*data*/ ctx[7][0].link)) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "title", "twitch");
    			attr_dev(iframe, "height", "378");
    			attr_dev(iframe, "width", "620");
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "scrolling", "no");
    			iframe.allowFullscreen = "true";
    			add_location(iframe, file, 73, 4, 2472);
    		},
    		m: function mount(target, anchor) {
    ...
    // (69:3) {#if data[0].platform == 'youtube'}
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			iframe = element("iframe");
    			add_location(h2, file, 69, 4, 2153);
    			...
    			iframe.allowFullscreen = true;
    			add_location(iframe, file, 70, 4, 2178);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(69:3) {#if data[0].platform == 'youtube'}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "天使即將開台了!";
    			t1 = space();
    			iframe = element("iframe");
    			add_location(h2, file, 64, 4, 1907);
    			if (!src_url_equal(iframe.src, iframe_src_value = /*data*/ ctx[7][0].link)) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "title", "twitch");
    			attr_dev(iframe, "height", "378");
    			attr_dev(iframe, "width", "620");
    			...
    			attr_dev(iframe, "scrolling", "no");
    			iframe.allowFullscreen = "true";
    			add_location(iframe, file, 65, 4, 1930);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    ...
    // (61:3) {#if data[0].platform == 'youtube'}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			iframe = element("iframe");
    			add_location(h2, file, 61, 4, 1615);
    			attr_dev(iframe, "width", "560");
    			attr_dev(iframe, "height", "315");
    			if (!src_url_equal(iframe.src, iframe_src_value = /*data*/ ctx[7][0].link)) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "title", "YouTube video player");
    			...
    			attr_dev(iframe, "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");
    			iframe.allowFullscreen = true;
    			add_location(iframe, file, 62, 4, 1638);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(61:3) {#if data[0].platform == 'youtube'}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(52:17)    <p>讀取資料中</p>   {:then data}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			h1 = element("h1");
    			h1.textContent = "天使開台了嗎?";
    			t2 = space();
    			info.block.c();
    			if (!src_url_equal(img.src, img_src_value = "bg.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "svelte-1pxr90");
    			add_location(img, file, 47, 3, 1252);
    			attr_dev(div0, "class", "layer svelte-1pxr90");
    			add_location(div0, file, 45, 3, 1178);
    			attr_dev(div1, "class", "bg svelte-1pxr90");
    			add_location(div1, file, 44, 1, 1157);
    			attr_dev(h1, "class", "svelte-1pxr90");
    			add_location(h1, file, 50, 1, 1292);
    			attr_dev(main, "class", "svelte-1pxr90");
    			add_location(main, file, 43, 0, 1148);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function clock() {
    		const livetine = lib.current() - globalThis.livetine;
    		$$invalidate(0, day = Math.floor(livetine / (3600 * 24)));
    		$$invalidate(1, hour = Math.floor(livetine % (3600 * 24) / 3600));
    		$$invalidate(2, min = Math.floor(livetine % 3600 / 60));
    		$$invalidate(3, sec = Math.floor(livetine % 60));
    		console.log(day);
    		console.log(hour);
    		console.log(min);
    		console.log(sec);
    	...
    	function totimestamp(time) {
    		...
    		return '<p>上次開台時間: ' + lib.toDatetimeString(time, { format: 'YYYY' }) + "年" + lib.toDatetimeString(time, { format: 'MM' }) + "月" + lib.toDatetimeString(time, { format: 'DD' }) + "日" + '</p>';
    	}
    	...
    	return [day, hour, min, sec, totimestamp, promise];
    }
